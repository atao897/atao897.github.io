...
function StartSymboltest_self() {
    ...
    localStorage.letterorSymbol = "Symbol";
    localStorage.pageNum = "2";
    window.location.href='./selfTesting/instructions1a.html';
}
...
function StartLettertest_self() {
    ...
    localStorage.letterorSymbol = "Letter";
    localStorage.pageNum = "2";
    window.location.href='./selfTesting/instructions99.html';
}
...
var instructionPages = [
    {
        "image":"ifrm0.html",
        "head":"Symbols",
        "html":"<p>The black and white symbols are what the patient will see in the test. Check your patient can name them all! Note that it doesn’t really matter what your patient calls them as long as you know which one they mean!</p>"
    },
    {
        "image":"images/instruct-1.svg",
        "head":"This test requires two people",
        "html":"<ol><li><b class='red'>1</b>The patient having their eyes tested</li><li><b class='blue'>2</b>An examiner to enter the patients' answers into the computer</li></ol>",
        "extraClass":"tag"
    },
    {
    ...
    },
    {
        ...
        "head":"Make sure the patient has a clear view of the display",
        "html":"<p><em>They should wear their glasses unless they've been told not to by their clinician</em>.</p>"
    },
    {
        "image":"ifrm6.html",
        "head":"Measure the distance",
        "html":"<p>They need to be seated as far away as possible at one of these distances. Click your choice then use either a tape measure or the A4 sheets to measure the distance to the screen.</p>"
    },
    {
        "image":"images/instruct-7.svg",
        "head":"Now please have the patient cover their left eye",
        "html":"<p>Make sure they cover the correct eye (have them copy the picture if it helps!) It is very important they keep this eye covered during the test.</p>"
    },
    {
        "image":"images/instruct-8.svg",
        "head":"Next a letter or symbol will appear on the screen",
        "html":"<p>Have the patient call out its name. Click the chosen symbol from the bottom row on the screen. There will be a few of these.</p>"
    },
    {
        "image":"images/instruct-9.svg",
        "head":"Once you click, a new symbol appears and you repeat the process",
        "html":"<p>The test gets tough. Encorage the patient to guess if they don't know.</p>"
    },
    {
        "image":"images/instruct-10.svg",
        "head":"Once the test completes, the patient switches the hand to the right eye",
        "html":"<p></p>"
    },
    {
